...
public class ComponenteRobot extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.drawString(nombre, baseX - 10 + (robot.getTamano() - nombreTa) / 2, robot.getY() - 20);
        ...
        g2d.fillOval(robot.getX() + ojosTa, robot.getY() + ojosTa, ojosTa, ojosTa); // Ojo derecho
        g2d.fillOval(robot.getX() + 3 * ojosTa - 5, robot.getY() + ojosTa, ojosTa, ojosTa); // Ojo izquierdo
        g2d.setColor(Color.BLACK);
        g2d.fillOval(robot.getX() + 3 * ojosTa - ojosTa / 4 - 2, robot.getY() + ojosTa + ojosTa / 4, ojosTa / 2, ojosTa / 2); // Pupila ojo izquierdo
        g2d.fillOval(robot.getX() + ojosTa + ojosTa / 4, robot.getY() + ojosTa + ojosTa / 4, ojosTa / 2, ojosTa / 2); // Pupila ojo derecho
        ...
        // Dibuja las orejas
        g2d.setColor(new Color(139, 69, 19)); // Color marrón
        g2d.fillOval(robot.getX() - orejaTa / 2, robot.getY() + ojosTa / 2, orejaTa, orejaTa);
        g2d.fillOval(robot.getX() + robot.getTamano() - orejaTa / 2, robot.getY() + ojosTa / 2, orejaTa, orejaTa);

        // Dibuja el sombrero
        g2d.setColor(Color.BLACK);
        g2d.fillRect(robot.getX() + robot.getTamano() / 4, robot.getY() - robot.getTamano() / 4, robot.getTamano() / 2, robot.getTamano() / 4);
        g2d.fillRect(robot.getX() + robot.getTamano() / 3, robot.getY() - robot.getTamano() / 3, robot.getTamano() / 3, robot.getTamano() / 6);
