 ...
 */
public class BotonAni extends JButton {
    private static final long serialVersionUID = 1L;
    protected Animator animator;
    protected int tamMaxBtn;
    protected float tamAnim;
    protected Point puntoPresionado;
    protected float alpha;
    protected Color colorEfecto = new Color(173, 173, 173);
